...
<section class="py-5">
  <div class="container px-4 px-lg-5 my-5">
    <div class="row gx-4 gx-lg-5 align-items-center">
      <div class="col-md-6">
        <img class="card-img-top mb-5 mb-md-0" src="{{asset('uploads/img1.png')}}" alt="..." />
          ...
          <div class="row">
            ...
            <div class="col-md-4 my-2">
              <form action="{{route('razorpay.payment')}}" method="POST">
                @csrf
                <script src="https://checkout.razorpay.com/v1/checkout.js" data-key="{{config('razorpay.key')}}" data-amount="{{ 40 * 100}}" data-buttontext="Pay With Razorpay" data-name="test payment" data-description="Payment" data-prefill.name="user" data-prefill.email="user@gmail.com" data-theme.color="#ff7529">
                </script>
              </form>
            </div>
            <div class="col-md-4 my-2">
